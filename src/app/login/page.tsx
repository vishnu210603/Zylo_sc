...
//   const redirect = searchParams.get('redirect') || '/designs';
...
//               className="w-full py-2 border border-gray-300 rounded-lg flex items-center justify-center space-x-2 hover:bg-gray-50"
//             >
//               <img

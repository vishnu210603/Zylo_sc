...
export default function ParallaxBoxWithPrompt() {
  ...
  return (
    <div className="relative w-full h-[350px] overflow-hidden rounded-xl flex justify-center items-center px-4">
      {/* Canvas Background */}
      <canvas
        ref={canvasRef}
      ...
      <PromptBox
        onSubmit={(input, attachments) => {
          // You can handle submitted data here if needed
          console.log('Received from PromptBox:', input, attachments);
        }}
      />
    </div>
  );

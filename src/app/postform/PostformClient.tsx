...
//                   disabled
//                 />
//                 <Eye className="absolute right-3 top-2.5 text-gray-400 h-5 w-5" />
//               </div>
//             </div>
...
//                 className="accent-[#0063F7] w-4 h-4"
//                 required
//               />
...
export default function FeedbackForm() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault(); // prevent browser default form validation

    if (!likeText.trim()) {
      setError('Please tell us what you liked.');
      return;
    }
    ...
    <form onSubmit={handleSubmit} noValidate>
      <div className="bg-white p-6 rounded-xl w-[400px] shadow-xl">
        <div className="text-center">
          ...
          <h2 className="text-lg font-semibold">Thank you for posting!</h2>
        ...
        <button
          type="submit"
          className="mt-6 w-full bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium py-2 rounded-lg"
        >
          Submit Feedback
        </button>
      </div>
